...
<html>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           <div class="col-sm-3">
       <br/>
   <a class="btn btn-default btn-mini"  href="${pageContext.request.contextPath}/admin/mail">Inbox</a>
   <br/><br/>
   <a class="btn btn-info btn-mini"  href="${pageContext.request.contextPath}/admin/mail/sent">Sent</a>
           </div>
           <div class="col-sm-9">
                <br/>
               <br/>
                ...
                <c:if test="${(not empty mails)}">
                 <c:forEach items="${mails}" var="entity">
                     <div class="row well span3" >
                        <c:if test="${not empty entity.receiver.username}"/>
                        <h4>To : <c:out value="${entity.receiver.name}" /> (<c:out value="${entity.receiver.username}" />)</h4><br/>
